...
package body Utility.Maps is
   ...
   begin
      ...
      if Contains (Image, (1 => Deg_Chr)) then
   ...
   -- (See specification file)
   --===========================================================================
   function Intersection (A1, B1, A2, B2 : Position_Record) return Position_Record is
      PA1 : Vector2_Record := New_Vector2_Record (A1.Lon, A1.Lat);
      PB1 : Vector2_Record := New_Vector2_Record (B1.Lon, B1.Lat);
      PA2 : Vector2_Record := New_Vector2_Record (A2.Lon, A2.Lat);
      PB2 : Vector2_Record := New_Vector2_Record (B2.Lon, B2.Lat);
      E   : Vector2_Record := New_Vector2_Record (No_Position_Record.Lon, No_Position_Record.Lat);
      R   : Vector2_Record := Math.Tools.Intersection (PA1, PB1, PA2, PB2, E);
   begin
