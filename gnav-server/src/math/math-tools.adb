...
package body Math.Tools is
   ...
   --===========================================================================
   function Intersection (A1, B1, A2, B2, E : Vector2_Record) return Vector2_Record is
      V1 : Vector2_Record := B1 - A1;
      V2 : Vector2_Record := B2 - A2;
      Ax : Long_Float     := A2.Get_X - A1.Get_X;
      Ay : Long_Float     := A2.Get_Y - A1.Get_Y;
      D,
      T  : Long_Float;
      S  : Long_Float;
   begin

      D := V1.Get_Y * V2.Get_X - V1.Get_X * V2.Get_Y;

      if D /= 0.0 then

         T := (V2.Get_X * Ay - V2.Get_Y * Ax) / D;

         if T in 0.0..1.0 then

            S := (V1.Get_X * Ay - V1.Get_Y * Ax) / D;

            if S in 0.0..1.0 then

               return New_Vector2_Record (X => A1.Get_X + T * V1.Get_X,
                                          Y => A1.Get_Y + T * V1.Get_Y);
   ...
   -- (See specification file)
   --===========================================================================
   function Contains_Point (Points : Math.Vector2_List.Stack; X, Y : Long_Float) return Boolean is
   ...
   --===========================================================================
   function Inside_Offset (Points  : Math.Vector2_List.Stack;
   ...
   -- (See specification file)
   --===========================================================================
   procedure Clean_Line (Points : in out Math.Vector2_List.Stack; Resolution : Long_Float) is
   ...
   -- (See specification file)
   --===========================================================================
   function Get_Minimum_Distance (Points : Math.Vector2_List.Stack;
                                  Point  : Vector2_Record;
   ...
   -- (See specification file)
   --===========================================================================
   function Get_Closest_Node (Points : Math.Vector2_List.Stack;
   ...
   -- (See specification file)
   --===========================================================================
   function Get_Closest_Point (Points : Math.Vector2_List.Stack;
                               Point  : Vector2_Record;
   ...
   --===========================================================================
   procedure Get_Closest_Point (Points  : Math.Vector2_List.Stack;
                                Point   : Vector2_Record;
                                Closed  : Boolean;
   ...
   -- (See specification file)
   --===========================================================================
   function Get_Curvilinear_Coordinate (Points : Math.Vector2_List.Stack;
   ...
   -- (See specification file)
   --===========================================================================
   function Insert_Point (Points    : in out Math.Vector2_List.Stack;
                          Point     : Vector2_Record;
   ...
   -- (See specification file)
   --===========================================================================
   function Get_Length (Points : Math.Vector2_List.Stack) return Long_Float is
   ...
   -- (See specification file)
   --===========================================================================
   function Get_Point_At (Points : Math.Vector2_List.Stack;
   ...
   -- (See specification file)
   --===========================================================================
   function Get_Geometric_Center (Points : Math.Vector2_List.Stack) return Vector2_Record is
