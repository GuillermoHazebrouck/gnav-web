...
package Math.Tools is
   ...
   --===========================================================================
   -- If the segments A1-B1 and A2-B2 intersect, it returns the intersection,
   -- otherwise it returns E.
   --===========================================================================
   function Intersection (A1, B1, A2, B2, E : Vector2_Record) return Vector2_Record;

   --===========================================================================
   -- Indicates if the given point is located inside the polygon. This algorithm
   -- is based in the number of horizontal cuts.
   --===========================================================================
   function Contains_Point (Points : Math.Vector2_List.Stack; X, Y : Long_Float) return Boolean;
   ...
   --===========================================================================
   procedure Clean_Line (Points : in out Math.Vector2_List.Stack; Resolution : Long_Float);
   ...
   --===========================================================================
   function Get_Length (Points : Math.Vector2_List.Stack) return Long_Float;
   ...
   --===========================================================================
   function Get_Geometric_Center (Points : Math.Vector2_List.Stack) return Vector2_Record;
