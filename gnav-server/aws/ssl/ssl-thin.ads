...
package SSL.Thin is
   ...
   GNUTLS_SEC_PARAM_UNKNOWN   : constant gnutls_sec_param_t :=   0;
   GNUTLS_SEC_PARAM_INSECURE  : constant gnutls_sec_param_t := -20;
   GNUTLS_SEC_PARAM_EXPORT    : constant gnutls_sec_param_t := -15;
   GNUTLS_SEC_PARAM_VERY_WEAK : constant gnutls_sec_param_t := -12;
   GNUTLS_SEC_PARAM_WEAK      : constant gnutls_sec_param_t := -10;
   GNUTLS_SEC_PARAM_LOW       : constant gnutls_sec_param_t :=   1;
   GNUTLS_SEC_PARAM_LEGACY    : constant gnutls_sec_param_t :=   2;
   GNUTLS_SEC_PARAM_MEDIUM    : constant gnutls_sec_param_t :=   3;
   ...
   GNUTLS_SEC_PARAM_HIGH      : constant gnutls_sec_param_t :=   4;
   GNUTLS_SEC_PARAM_ULTRA     : constant gnutls_sec_param_t :=   5;
