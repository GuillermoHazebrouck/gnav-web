...
package body Display.Pages.Route_Edition is
   ...
   begin
      ...
      Pnl_Left.Set_Background_Color (Color_Gray_2);
      ...
      Pnl_Right.Set_Background_Color (Color_Gray_2);
      ...
      Allocation.W := 0.48 * W;
      Allocation.H := 0.90 * H;
      Allocation.Y := Ent_Route.Get_Allocation.Y - 1.1 * H;
      ...
      Allocation.W := 0.48 * W;
      Allocation.H := 0.90 * H;
      Allocation.Y := Ent_Waypoint.Get_Allocation.Y - H - 0.01;
      ...
      D := Btn_Wypnt_Prepend.Get_Allocation.Y - 1.5 * H - 0.02;
