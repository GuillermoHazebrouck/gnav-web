...
package Utility.Events is
   ...
   --===========================================================================
   procedure Connect (This : in out Event_Stack; Callback : Callback_Type);

   --===========================================================================
   -- Triggers the event by calling all connected callbacks
   --===========================================================================
   procedure Trigger (This : Event_Stack);
