...
package body Utility.Atmosphere is
   ...
   --===========================================================================
   function To_Altitude (Level : Float; Target_Unit : Altitude_Units) return Float is
   begin
   ...
   begin
      ...
      return To_Altitude (Level, Altitude_Unit);
   ...
   begin
      ...
      if Data'Length > 1 and then Data (Data'Last) = 'M' then

         --Eg.: 750M

         H := Float_Value (Data (Data'First+1..Data'Last));
         ...
         if Data = "GND" then
            ...
            if Qnh_Valid or Forced then
               ...
               H := Float_Value (Trim (Data (Data'First+2..Data'Last)));
            ...
            H := Float_Value (Data (Data'First..Data'Last-2));
   ...
   exception
      ...
      when others =>
         ...
         Utility.Log.Put_Message ("warning: invalid altitude " & Value);
   ...
   --
   --===========================================================================
   function To_Altitude (Value : Altitude_Strings) return Float is
   ...
   begin
      ...
      if Data'Length > 1 and Data (Data'Last) = 'M' then

         --Eg.: 750M

         H := Float_Value (Data (Data'First+1..Data'Last));

         H := Convert (H, Unit_Meter, Unit_Meter);

      elsif Data'Length > 2 then

         if Data (Data'First) = 'F' and then Data (Data'First+1) = 'L' then

            -- Eg.: FL055

            H := Float_Value (Trim (Data (Data'First+2..Data'Last)));

            H := To_Altitude (H, Unit_Meter);
            ...
            H := Convert (H, Unit_Feet, Unit_Meter);
