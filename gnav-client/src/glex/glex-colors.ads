...
package Glex.Colors is
   ...
   Color_Magenta    : constant Color_Record := (R => 1.0, G => 0.3, B => 1.0, A => 1.0);
   Color_Black      : constant Color_Record := (R => 0.0, G => 0.0, B => 0.0, A => 1.0);

   Color_Sky        : constant Color_Record := (R => 0.1, G => 0.1, B => 0.8, A => 1.0);
   Color_Ocean      : constant Color_Record := (R => 0.2, G => 0.3, B => 1.0, A => 1.0);
   ...
   Color_Brown      : constant Color_Record := (R => 0.7, G => 0.6, B => 0.2, A => 1.0);
   ...
   Color_Gold       : constant Color_Record := (R => 1.0, G => 0.8, B => 0.0, A => 1.0);
