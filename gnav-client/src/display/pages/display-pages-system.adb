...
package body Display.Pages.System is
   ...
   Active_Page : Page_Types := Page_Check;
   ...
   begin
      ...
      Btn_Check.Set_Style (Button_Enabled);
         
      Btn_Check.Set_Font_Size (0.4, 0.3, 0.6);
      
      Btn_Check.Set_Label ("INFO");
   ...
   begin
      ...
      Btn_Check.Set_Style  (Button_Normal);
      ...
      if Btn_Aprs.Contains (X, Y) then
         ...
         case Active_Page is
            ...
            when Page_Check =>
               ...
               Pages.Check.Screen_Pressed (X, Y);
   ...
   begin
      ...
      case Active_Page is
         ...
         when Page_Check =>
            ...
            Pages.Check.Screen_Move (X, Y, Dx, Dy, First);
