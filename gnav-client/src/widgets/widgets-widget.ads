...
package Widgets.Widget is
   ...
   --===========================================================================
   function Get_Visible (This : Widget_Record'Class) return Boolean;
   ...
   --===========================================================================
   function Get_Background_Color (This : Widget_Record'Class) return Color_Record;

   --===========================================================================
   -- Gets the border color of the widget
   --===========================================================================
   function Get_Border_Color (This : Widget_Record'Class) return Color_Record;
   ...
   --===========================================================================
   function Contains (This : Widget_Record'Class; X, Y : Float) return Boolean;
